...
go_analysis <- function(genes, keyType, org,targetPath){
  ...
  if (nrow(hh)>=1){
    ...
    p1<-dotplot(result,font.size=12, split="ONTOLOGY")+facet_grid(ONTOLOGY~., scale="free")
    print(p1)
    ...
    p4<-barplot(result,font.size=12, split="ONTOLOGY")+facet_grid(ONTOLOGY~., scale="free")
    print(p4)
...
targetPath = "."
genes <- c("AP3B1","PFDN2","BNIP1","COPB1","NUDCD1","DIAPH1","TCOF1","TERF2IP","HLA-C","VPS26B","IRF2BP2","FNBP1L","HINT3","CLNS1A","TFB2M","PTPN12","OCLN","NACA","UBQLN2","USP24","STX6","RPL37A","TPR","IPO11","PCNA","MAP2K2","MRPL12","C11orf70","SLC12A2","MRPS27","ALAS1","PELO","DYNLT3","IQSEC1","JMJD6","ATG5","MYO1G","PPIP5K2","RAB27A","HOOK3","CRTAP","NSFL1C","CWF19L1","MCM2","LYPLAL1","PDAP1","CUL5","RTCA","BTF3","PDS5A","PPFIA1","C14orf104","THOC2","YBX3","RIOK1","SUMO1","EPS8","SF3A1","RAB3GAP0","VPS33A","IRF3","ATP5S","EXOSC2","GOSR2","ILF3","ELMO2","GOLGB1","OPTN","ITGB5","CSTF3","LRPAP1","PPAPDC2","LRRC40","UNG","STAT2","RPS8","HGS","THOC6","EFEMP1","VPS45","DNAJC3")
keyType <- "SYMBOL"
org<-'hsa'
go_analysis(genes, keyType, org, targetPath)
kegg_analysis(genes,keyType, org, targetPath)
